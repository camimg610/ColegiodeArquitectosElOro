	...
	<main class="full-box main-container">
		...
		<section class="full-box page-content">
			...
			<div class="full-box tile-container">
				<div class="tile">
					...
					<div class="tile-icon">
						...
						<p><?php echo e($stats['total_usuarios']); ?></p>
					</div>
				</div>
				...
				<div class="tile">
					...
					<div class="tile-icon">
						...
						<p><?php echo e($stats['total_eventos']); ?></p>
					</div>
				</div>
				...
				<div class="tile">
					...
					<div class="tile-icon">
						...
						<p><?php echo e($stats['total_inscripciones']); ?></p>
					</div>
				</div>
				...
				<div class="tile">
					...
					<div class="tile-icon">
						...
						<p><?php echo e($stats['total_alquileres']); ?></p>
					</div>
				</div>
			</div>
			...
			<div class="full-box tile-container">
				...
				<a href="<?php echo e(route('usuarios.index')); ?>" class="tile">
				...
				<a href="<?php echo e(route('inscripciones.index')); ?>" class="tile">
				...
				<a href="<?php echo e(route('eventos.index')); ?>" class="tile">
				...
				<a href="<?php echo e(route('alquiler.index')); ?>" class="tile">
...
<?php /**PATH E:\SEmestre pasado\Disco-cami\Proj_ppi_02\Proj_ppi_01\resources\views/inicio/inicio.blade.php ENDPATH**/ ?>