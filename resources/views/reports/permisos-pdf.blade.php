...
<body>
    ...
    <div class="summary">
        ...
        <p><strong>Total de permisos:</strong> {{ $permisos->count() }}</p>
        <p><strong>Permisos activos:</strong> {{ $permisos->where('activo', true)->count() }}</p>
        <p><strong>Permisos inactivos:</strong> {{ $permisos->where('activo', false)->count() }}</p>
    </div>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="{{ $permiso->activo ? 'status-active' : 'status-inactive' }}">
