							...
							<table class="table table-dark table-sm">
								...
								<tbody id="userTableBody">
									...
									<tr>
										...
										<td>{{ $role->updated_at ? $role->updated_at->format('d/m/Y H:i') : 'N/A' }}</td>
										<td><button class="action-btn edit-btn" onclick="confirmAction('edit', this)">Editar</button></td>
										<td><button class="action-btn delete-btn" onclick="confirmAction('delete', this)" data-role-id="{{ $role->id_rol }}">Eliminar</button></td>
									</tr>
									@empty
									<tr>
